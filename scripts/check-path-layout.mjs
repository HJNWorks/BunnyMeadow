...
const ch3Ink = parsePosBlock("CH3_INK_POS")
const ch3Art = parsePosBlock("CH3_ART_POS")
...
checkLayout("Ch3 Ink", ch3Ink, 980, 420, 160, 96)
checkLayout("Ch3 Art", ch3Art, 1100, 620, 124, 78)
